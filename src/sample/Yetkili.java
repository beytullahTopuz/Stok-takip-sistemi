...
public class Yetkili extends Kullanici {
    ...
    public Yetkili(String isim, String soyisim, String sifre, String tc, String telefon, String eMail, String adres, String calisanNo, String maas) {
        this.isim = isim;
